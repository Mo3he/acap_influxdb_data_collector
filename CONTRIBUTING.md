...
repository root. It sends metrics to InfluxDB v2, so to test end to end you
also need an InfluxDB v2 instance (see `README.md`). Install the `.eap` on a
camera under **Apps > Add app**, then check the app log under
...
4. Update `README.md` when behaviour, metrics, or settings change.
